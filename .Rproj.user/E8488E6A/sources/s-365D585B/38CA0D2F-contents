...
#'
#' @note In development. Final draft. Note the appearance of the legend still needs some fiddling.
#'
...
category_maps <- function(SOOS_WG_data = NULL, outdir, category_data, plot_type = "WG", category_colours = SOOScol,
                          category_values = NULL, plot_legend = T, category_names = NULL, category_legend = NULL,
                          country_names_data = NULL, institution_names_data = NULL,
